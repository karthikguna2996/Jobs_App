    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Ionicons name="id-card-outline" size={20} color="#64748b" />
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailLabel}>Job_id</Text>
            <Text style={styles.detailValue}>{job?.job_role_id || 'Not specified'}</Text>
          </View>
        </View>
        <View style={styles.detailItem}>
        <Ionicons name="calendar-outline" size={20} color="#64748b" />
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailValue}>{job?.expire_on || 'Not specified'}</Text>
          </View>
        </View>
        <View style={styles.detailItem}>
        <Ionicons name="briefcase-outline" size={20} color="#64748b" />
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailValue}>{job?.job_role || 'Not specified'}</Text>
          </View>
        </View>
        <View style={styles.detailItem}>
        <Ionicons name="layers-outline" size={20} color="#64748b" />
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailValue}>{job?.job_category || 'Not specified'}</Text>
          </View>
        ...
        <Ionicons name="people-outline" size={20} color="#64748b" />
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailLabel}>Number of Appilications</Text>
            <Text style={styles.detailValue}>{job?.num_applications|| 'Not specified'}</Text>
          </View>
      ...
      <View style={styles.detailItem}>
          ...
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailLabel}>Number of Appilications</Text>
            <Text style={styles.detailValue}>{job?.fees_charged|| 'Not specified'}</Text>
          </View>
      ...
      <View style={styles.detailItem}>
          ...
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailValue}>{job?.other_details|| 'Not specified'}</Text>
          </View>
